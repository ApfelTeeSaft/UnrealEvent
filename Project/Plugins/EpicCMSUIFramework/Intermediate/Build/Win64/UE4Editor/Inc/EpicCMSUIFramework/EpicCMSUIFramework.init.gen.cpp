...
void EmptyLinkFunctionForGeneratedCodeEpicCMSUIFramework_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_EpicCMSUIFramework()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_EpicCMSUIFramework_onLoadingCompleted__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_EpicCMSUIFramework_OnCMSTileConfirmed__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/EpicCMSUIFramework",
