...
void EmptyLinkFunctionForGeneratedCodeMeshNetwork_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_MeshNetwork()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_MeshNetwork_OnConnectedToRootChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_MeshNetwork_OnGameServerNodeTypeChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_MeshNetwork_OnMeshMetaDataUpdated__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_MeshNetwork_OnMeshNodeTypeChanged__DelegateSignature,
			};
