...
void EmptyLinkFunctionForGeneratedCodeScreenCapture_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_ScreenCapture()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_ScreenCapture_ScreenCaptureFinishedDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ScreenCapture_ScreenCaptureInterruptedDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ScreenCapture_ScreenshotCapturedDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ScreenCapture_VideoSavedToAlbumDelegate__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/ScreenCapture",
